...
export function BottomNav() {
  ...
  const isHome = p === "/home";
  const isPost = p === "/post";
  const isProfile = p === "/profile" || p?.startsWith("/profile/");
  ...
  return (
    ...
    >
      <Link href="/home" style={{ display:"flex",flexDirection:"column",alignItems:"center",gap:5,color:col(isHome),textDecoration:"none",padding:"4px 0" }}>
      ...
      <Link href="/post" style={{ display:"flex",flexDirection:"column",alignItems:"center",gap:5,color:col(isPost),textDecoration:"none",padding:"4px 0" }}>
        <svg width="19" height="19" viewBox="0 0 20 20" fill="none">
      ...
      <Link href="/profile" style={{ display:"flex",flexDirection:"column",alignItems:"center",gap:5,color:col(isProfile),textDecoration:"none",padding:"4px 0" }}>
        <svg width="19" height="19" viewBox="0 0 20 20" fill="none">

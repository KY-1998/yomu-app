...
export default function RegisterPage() {
  ...
  // 招待リンク経由の場合、sessionStorage から自動入力
  useEffect(() => {
        const saved = sessionStorage.getItem("yomu_invite_code");
  ...
  return (
        <div className="flex min-h-dvh flex-col items-center justify-center gap-10 p-6">
              <div className="flex flex-col items-center gap-2">
                      <h1 className="font-latin text-4xl font-bold tracking-tight">yomu</h1>h1>
                {step === "code" ? (
                ...
                {step === "code" ? (
                    <>
                                <div className="flex flex-col gap-2">
                                              <input
                                                              ...
                                                              />
                                  {codeError && (
                                      <p className="text-xs text-red-500 text-center">{codeError}</p>p>
                                              )}
                                </div>div>
                                <Button
                                                size="lg"
                    ...
                    <>
                                ...
                                <div className="flex items-center gap-3">
                                              ...
                                              <span className="text-xs text-muted">または</span>span>
                                              <div className="flex-1 border-t border-border" />
                                </div>div>
                      ...
                      {magicSent ? (
                                    <div className="flex flex-col items-center gap-2 rounded-xl bg-muted/20 p-4 text-center">
                                                    ...
                                                    <p className="text-sm font-medium">メールを送りました</p>p>
                                                    <p className="text-xs text-muted">
                                    ...
                                    <div className="flex flex-col gap-2">
                                      ...
                                      {magicError && (
                                                        <p className="text-xs text-red-500">{magicError}</p>p>
                                                    )}
